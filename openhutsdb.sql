...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-09-2019 a las 13:09:03
...
(8, 'Refugi Estanys de la Pera', 'Enlairat a 2.357 m d’altitud, el refugi Estanys de la Pera es troba al vessant sud del port de Perafita, al costat dels estanys de la Pera. L’equipament, inaugurat l’any 1957, és punt de pas del GR 11.10, una de les variants del sender de gran recorregut transpirinenc per excel•lència, que comunica la Cerdanya amb el Principat d’Andorra.', 42.4566, 1.5988, 0, 1, 2, 2, 2, NULL),
...
CREATE TABLE `users` (
  ...
  `description` text COLLATE latin1_bin NOT NULL,
  `img` text COLLATE latin1_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
